...
from matrix_utils import construct_orthogonal, construct_random_sz_unitary
import pickle
import os
from CAS.format_dmrg.format_dmrg_param import get_dmrg_param, get_dmrg_process_param
from CAS.format_dmrg.format_tensor import get_correct_permutation
from CAS.validator.symmetry_check import check_permutation_symmetries_complex_orbitals
from CAS.validator.fci_ground_energy import get_fci_ground_energy
...
def cas_to_dmrg(onebody_matrix, tbt):
    """
    Given a CAS hamiltonian file, we extract its structure and pass it to the DMRG calculator.
    Args:
...
if __name__ == "__main__":
    ...
    ground_energy = get_fci_ground_energy(two_body_tensor)

    print("FCI Ground energy", ground_energy)
